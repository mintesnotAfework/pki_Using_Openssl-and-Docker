...
cp ../email-server/etc/email-server.conf etc/email-server.conf

openssl req -new -config etc/email-server.conf -out ../issuing-ca/csr/$file_name.csr -keyout private/$file_name.key
